...
# Commit changes
git commit -m "Initial commit: Gadget Hub automation framework"
...
# Commit with message
git commit -m "Add: new product scenarios"
...
# Merge to main
git checkout main
git merge feature/add-cart-tests
git push
```

## 🚫 Files Ignored by Git

The following are automatically ignored (see [.gitignore](.gitignore)):
- `node_modules/` - Dependencies
- `playwright-report/` - Test reports
- `test-results/` - Test artifacts
- `screenshots/` - Failure screenshots  
- `cucumber-report.html` - Generated reports
...
2. ✅ **Centralized Configuration** - Single source of truth for constants
3. ✅ **Error Handling** - Try-catch blocks with descriptive messages
4. ✅ **No Hard Waits** - Relies on Playwright's auto-waiting
5. ✅ **Explicit Waits Only When Needed** - `waitForLoadState()` for network
6. ✅ **BDD with Gherkin** - Business-readable scenarios
7. ✅ **Descriptive Naming** - Clear test and method names
8. ✅ **Test Data Separation** - External test data files
9. ✅ **Screenshots on Failure** - Automatic debugging artifacts
10. ✅ **Comprehensive JSDoc** - Well-documented code
